package edu.umich.eecs.rtcl.carlab.sources.sensors;
...
public class OpenXcSensors {
    ...
    public static Class nameToClass(String sensor) {
        switch (sensor) {
            case SPEED: return VehicleSpeed.class;
            case STEERING: return SteeringWheelAngle.class;
            case ENGINERPM: return EngineSpeed.class;
            case ODOMETER: return Odometer.class;
            case FUEL_SINCE_RESTART: return FuelConsumed.class;
            case FUEL: return FuelLevel.class;
            case ACCEL_PEDAL: return AcceleratorPedalPosition.class;
            case BRAKE_PEDAL: return BrakePedalStatus.class;
            case GEAR: return TransmissionGearPosition.class;
        }
